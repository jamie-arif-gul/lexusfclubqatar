                ...
                <table class="table table-striped table-advance table-hover" id="manage_users">
                    <thead>
                        <tr>
                            ...
                            <th class="col-xs-2 col-sm-2 col-md-2 text-center">Featured</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-xs-2 col-sm-2 col-md-2 text-center"><?php echo ($result['is_feature'] == 0)? '<i class="fa fa-ban">' : '<i class="fa fa-check"></i>'; ?></td>
