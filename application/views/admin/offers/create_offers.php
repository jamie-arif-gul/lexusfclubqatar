...
<section id="main-content">
    <section class="wrapper site-min-height">
        <!-- page start-->
        <section class="panel">
            <header class="panel-heading"> Create Offers</header>
            <div class="panel-body">
                ...
                <form method="post" role="form" id="create_user" action="administrator/create_offers" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6">
...
<!--                                    <input type="text" value="--><?php //echo set_value('description_ar') ?><!--" class="form-control" id="description_ar" name="description_ar" >-->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="file" value="<?php echo set_value('offers_image'); ?>" class="form-control"  id="offers_image" name="offers_image" >
                                </div>
                            </div>
