...
<section id="main-content">
    <section class="wrapper site-min-height">
        <!-- page start-->
        <section class="panel">
            <header class="panel-heading"> Create Frange</header>
            <div class="panel-body">
                ...
                <form method="post" role="form" id="create_user" action="administrator/create_frange" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="title_en">Frange Title</label>
...
<!--                                    <input type="text" value="--><?php //echo set_value('description_ar') ?><!--" class="form-control" id="description_ar" name="description_ar" >-->
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="frange_image">Frange Image</label>
                                    <input type="file" value="<?php echo set_value('frange_image'); ?>" class="form-control"  id="frange_image" name="frange_image" >
                                </div>
                            </div>
