...
<section id="main-content">
    <section class="wrapper site-min-height">
        <!-- page start-->
        <section class="panel">
            <header class="panel-heading"> Edit Frange</header>
...
//                var_dump();die;
                ...
                <form method="post" role="form" id="create_user" action="administrator/edit_frange/<?php echo $this->uri->segment(3); ?>" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6">
...
<!--                                    <input type="text" value="--><?php //echo set_value('description_ar'); echo $frange[1]['description'] ?><!--" class="form-control" id="description_ar" name="description_ar" >-->
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" value="" class="form-control"  id="frange_image" name="frange_image" >
                                </div>
                            </div>
