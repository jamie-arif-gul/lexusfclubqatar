...
<section id="main-content">
    <section class="wrapper site-min-height">
        <!-- page start-->
        <section class="panel">
            <header class="panel-heading"> Edit Offers Content</header>
...
//                var_dump();die;
                ...
                <form method="post" role="form" id="create_user" action="administrator/offers_content_edit" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6">
