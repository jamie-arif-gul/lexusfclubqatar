...
<section id="main-content">
    <section class="wrapper site-min-height">
        <!-- page start-->
        <section class="panel">
            <header class="panel-heading"> Frange Content</header>
            <div class="panel-body">
                ...
                <form method="post" role="form" id="create_user" action="administrator/frange_content_create" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6">
...
<!--                                    <input type="text" value="--><?php //echo set_value('title_ar') ?><!--" class="form-control" id="title_ar" name="title_ar" >-->
                                ...
                                <div class="form-group">
                                    <label for="description_ar"> مجموعة F  يحتوى وصف
</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="frange_c_image">Frange Content Image</label>
                                    <input type="file" value="<?php echo set_value('frange_c_image'); ?>" class="form-control"  id="frange_c_image" name="frange_c_image" >
                                </div>
                            </div>
