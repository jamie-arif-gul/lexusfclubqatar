...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo base_url('resources/admin'); ?>/img/favicon.html">
        <title>404</title>        
        <!-- Bootstrap core CSS -->
    ...
    <body class="body-404">
        <div class="container">    
            <section class="error-wrapper">
                ...
                <p class="page-404">Something went wrong or that page does not exist yet. <a href="<?php echo base_url('login'); ?>">Return Home</a></p>
            </section>
        </div>
    </body>
</html>
