...
<?php $this->load->view('errors'); ?>
      <div class="col-sm-6">
		...
		<div class="col-sm-12 padding0">
          ...
          <input type="text" class="form-control" name="date_from" value="<?php echo $property_data[0]['date_from']; ?>" id="check-in" placeholder="From" required>
		  </div>
		  <div class="col-sm-6 col-xs-12" style="padding-right: 0">
          <input type="text" class="form-control" name="date_to" value="<?php echo $property_data[0]['date_to']; ?>" id="check-out" placeholder="To" required>
		  </div>
        </div>
		<div class="clear5"></div>
        <div class="form-group">
		...
		<div class="col-sm-4 col-xs-12" style="padding-right: 0;">
            ...
            <input type="text" class="form-control" name="unit" id="" value="<?php echo $property_data[0]['unit']; ?>">
		</div>
        </div>
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="country_id" id="country_id" required>
            ...
            <option value="1" <?php if($property_data[0]['country_id'] == 1){ echo 'selected="selected"'; } ?> >United States</option>
            <?php 
            //helper function
            ...
            if($countries){
              foreach ($countries as $country) { ?>
                <option value="<?php echo $country['id']; ?>" <?php if($property_data[0]['country_id'] == $country['id']){ echo 'selected="selected"'; } ?> ><?php echo $country['country_name'];?></option>';
            <?php  }
            }else{
        ...
        <div class="clear10"></div>
        <input type="hidden" class="form-control" name="country" id="country" value="<?php echo $property_data[0]['country']; ?>" required>
...
<div class="clear10"></div>
        <div class="form-group">
          ...
          <div id="state_input" <?php if($property_data[0]['country_id'] == 1){ echo 'style="display:none"'; }else { echo 'style="display:block"'; } ?> >
            <input type="text" class="form-control" name="state" id="administrative_area_level_1" value="<?php echo $property_data[0]['state']; ?>" <?php if($property_data[0]['country_id'] == 1){ echo 'disabled="disabled"'; } ?> required>
          </div>
          
          <div id="state_select" <?php if($property_data[0]['country_id'] == 1){ echo 'style="display:block"'; }else { echo 'style="display:none"'; } ?> >
            <select class="form-control" name="state" id="state_id"  <?php if($property_data[0]['country_id'] != 1){ echo 'disabled="disabled"'; } ?> required>
            <option value="">Please Select</option>
            <?php
            //helper function
            //get('table',where array,fields1,field2,order by array)
...
<div class="clear10"></div>
		...
		<div class="form-group">
          ...
          <input type="number" class="form-control" name="area" value="<?php echo $property_data[0]['area']; ?>" id="square_feet" required>
        </div>
        <!--<div class="form-group">
