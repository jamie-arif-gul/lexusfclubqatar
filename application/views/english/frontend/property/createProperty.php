...
<?php $this->load->view('errors'); ?>
      <div class="col-sm-6">
		...
		<div class="col-lg-3 col-md-4 col-sm-6 col-xs-3 padding0">
            ...
            <input type="text" style="width:77%; float:right;" class="form-control" name="unit" id="" value="<?php echo set_value('unit'); ?>">
		</div>
        </div>
<div class="clear5"></div>
        <div class="form-group">
          ...
          <select class="form-control" onchange="get_stets(this)" name="country_id" id="country_id" required>
            ...
            <option value="United States" <?php echo set_select('country_id', 'United States'); ?> >United States</option>
            <?php
            //helper function
            ...
            if($countries){
              foreach ($countries as $country) { ?>
                <option value="<?php echo $country['country_name']; ?>" <?php echo set_select('country_id', $country['country_name']); ?> ><?php echo $country['country_name'];?></option>
            <?php  }
            }
            ?>
          </select>
...
<div class="clear5"></div>
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="bedrooms" id="bedrooms" required>
            <option value="">Please Select</option>
            <option value="Studio" <?php echo set_select('bedrooms', 'Studio'); ?> >Studio</option>
            <?php for ($i=1; $i <= 20; $i++) { ?>
...
<div class="clear5"></div>
  ...
  <div class="clear5"></div>
        ...
        <div class="form-group">
          ...
          <input type="number" class="form-control" name="area" value="<?php echo set_value('area'); ?>" id="square_feet" min="1" required>
        </div>
        <!--<div class="form-group">
